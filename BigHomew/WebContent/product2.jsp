	...
	<div>
		...
		<div class="header2">
			...
			<tr>
				...
				<td><a href="${ctx }/findproduct/findByHot?pagenum=1">最热商品</a></td>
			</tr>
		</div>
		...
		<script type="text/javascript">
			...
			<tr>
				<td><a href="${ctx }/findproduct/findByHot?pagenum=1&id=${id}">首页</a></td>
				<td><a href="${ctx }/findproduct/findByHot?pagenum=${prenum}&id=${id}">上一页</a></td>
				<td><a href="${ctx }/findproduct/findByHot?pagenum=${nextnum}&id=${id}">下一页</a></td>
			</tr>
		</div>
		<div class="footer">
